...
public class AccountRegisterAndLogin {
    ...
    public Account registerAccount(AccountRegistrationRequestDTO dto, Role role){
    ...
    public AccountResponseDTO registerResponse(Account account){
